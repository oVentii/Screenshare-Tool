...
public static class PrefetchScanner
{
        ...
        CancellationToken ct)
    {
        ...
        // Name format is EXECUTABLE-HASH; the executable itself may contain
        // dashes, so split at the LAST one (first-dash matching could pair
        // e.g. MY-APP.EXE-HASH.pf with the wrong binary).
